...
draw_text_transformed(questyActionX2, questyActionY, "- Ice", 0.5, 0.5, 0);
questyActionY += lineHeight;
draw_text_transformed(questyActionX1, questyActionY, "- Fire", 0.5, 0.5, 0);
draw_text_transformed(questyActionX2, questyActionY, "- Poison", 0.5, 0.5, 0);
questyActionY += lineHeight;
draw_text_transformed(questyActionX1, questyActionY, "- Sleep", 0.5, 0.5, 0);
draw_text_transformed(questyActionX2, questyActionY, "- Paralysis", 0.5, 0.5, 0); 